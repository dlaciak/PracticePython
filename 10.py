...
[NewList.append(element) for element in List1 if element in List2 and element not in NewList]
print(NewList)
...
[NewList2.append(element) for element in List3 if element in List4 and element not in NewList2]
